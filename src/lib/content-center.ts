...
export interface ContentCenterLauncher {
  id: string;
  label: string;
  description: string;
  icon: string;
...
export const CONTENT_CENTER_LAUNCHERS: readonly ContentCenterLauncher[] = [
  {
    id: 'webmail',
    label: 'WebMail',
  ...
  },
  {
    ...
    icon: 'file-pen-line',
    href: '/admin/',
    allowedGroups: ['Content Center - Content Editor', 'CMS Editors'],
    accessMode: 'any',
    order: 20,
    tone: 'purple',
  },
  {
    ...
    allowedGroups: ['Content Center - Confluence'],
    accessMode: 'any',
    external: true,
    order: 30,
    tone: 'navy',
...
export function canAccessLauncher(
  ...
  launcher: ContentCenterLauncher,
): boolean {
...
export function getVisibleLaunchers(
  userGroups: readonly string[],
  launchers: readonly ContentCenterLauncher[] = CONTENT_CENTER_LAUNCHERS,
): ContentCenterLauncher[] {
