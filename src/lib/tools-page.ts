...
export const TOOLS_PAGE_LAUNCHERS: readonly ToolsPageLauncher[] = [
  ...
  },
  {
    id: 'okta',
    label: 'Okta',
    description: 'Open your Late Diagnosed Okta dashboard.',
    icon: 'key',
    href: 'https://latediagnosed.okta.com/app/UserHome',
    external: true,
    order: 30,
    tone: 'purple',
  },
  ...
  },
  {
    id: 'jira',
    label: 'Jira',
    description: 'Open Late Diagnosed Jira.',
    icon: 'clipboard-list',
    href: 'https://latediagnosed.atlassian.net/jira/',
    allowedGroups: ['Tools - Jira'],
    accessMode: 'any',
    external: true,
    order: 50,
    tone: 'purple',
