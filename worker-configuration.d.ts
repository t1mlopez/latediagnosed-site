/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8de6355998e6ae9a02c3fcd32783d104)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	OKTA_ISSUER: string;
	OKTA_CLIENT_ID: string;
	OKTA_CLIENT_SECRET: string;
	OKTA_SESSION_SECRET: string;
	OKTA_PERMISSION_CLAIMS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OKTA_ISSUER" | "OKTA_CLIENT_ID" | "OKTA_CLIENT_SECRET" | "OKTA_SESSION_SECRET" | "OKTA_PERMISSION_CLAIMS">> {}
}
